...
const LandingFooter = () => {
  return (
    <footer className="w-full overflow-hidden bg-secondary/40">
      <div className="container-box mx-auto px-2.5 pt-10 grid grid-cols-2 gap-5 max-md:grid-cols-1">
        <section className="space-y-4 md:max-w-[450px]">
          <div className="flex items-center gap-2.5">
            <img
              ...
              height={36}
            />
            <h4 className="font-semibold text-xl text-copy">LinkChain</h4>
          </div>
          <p className="text-lg text-copy-light max-sm:text-lg">
        ...
        <section className="grid grid-cols-[repeat(auto-fit,_minmax(180px,_1fr))] gap-5">
          ...
          <div className="text-copy space-y-5">
            ...
            <Button
              type="button"
              className="bg-[#080808] hover:bg-[#101010] text-[#f4f4f4] focus-visible:ring-white"
              onClick={() =>
                window.open(
      ...
      <p className="container-box mx-auto text-sm text-copy-light py-5 px-2.5 border-t mt-4">
